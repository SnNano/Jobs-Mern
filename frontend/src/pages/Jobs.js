...
const Jobs = ({state, dispatch, search}) => {
            ...
            {filterJobs.length > 0 ? (filterJobs.map((job)=>{
              ...
              <div className=" p-6">
                  <div className="flex items-center justify-between">
                      ...
                      <Link to={`job/${job._id}`} className="font-bold text-teal-600">More Info<i className="ml-5 fa-solid fa-up-right-from-square"></i></Link>
                  </div>
